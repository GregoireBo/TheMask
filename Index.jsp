          ...
          <div class="container">
            ...
            <div class="row">
              <div class="col-md-3">
                ...
                <button type="button" class="btn btn-default btn-sm btn-block hidden-lg hidden-md" data-toggle="collapse" data-target="#demo">Précisez votre recherche <span class="caret"></span>
                ...
                <div id="demo" class="collapse in">
                    ...
                    <div class="list-group list-group">
                        ...
                        <a href="#" class="list-group-item"><span class="badge">X</span> CAT_1 <span class="label label-primary">New</span></a>
                        <a href="#" class="list-group-item"><span class="badge">X</span> CAT_2</a>	
                    </div>
